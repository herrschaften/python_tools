...
class ImageProcessor(QThread):
    ...
    def __init__(self, file_paths, num_colors, max_size=None, max_length=None, output_folder=None, custom_palette=None, use_dithering=True):
        super().__init__()
...
class IndexedColorConverter(QMainWindow):
    ...
    def setup_single_image_tab(self):
        ...
        # Pixel length for resize
        pixel_length_layout = QHBoxLayout()
        pixel_length_layout.addWidget(QLabel("Long Side Length (px):"))
        ...
        self.original_image_label.setMinimumSize(350, 200)
        ...
        right_panel.addWidget(QLabel("Indexed/Preview Image:"))
        self.indexed_image_label = QLabel()
        self.indexed_image_label.setAlignment(Qt.AlignCenter)
        self.indexed_image_label.setMinimumSize(350, 200)
    ...
    def setup_batch_tab(self):
        ...
        settings_layout.addWidget(QLabel("Max Longest Side (px):"), 3, 0)
        self.max_dimension_spin = QSpinBox()
        self.max_dimension_spin.setRange(0, 10000)
        self.max_dimension_spin.setValue(0)
        self.max_dimension_spin.setSpecialValueText("No Resize")
            ...
            with Image.open(self.current_indexed_image_path) as img:
                ...
                if palette:
                    ...
                    with tempfile.NamedTemporaryFile(suffix='.png', delete=False) as temp_file:
                        ...
                        self.load_image_preview(temp_path, self.indexed_image_label)
    ...
    def update_preview(self, qimage):
        ...
        # Scale down if needed to fit in the label
        if pixmap.width() > 350 or pixmap.height() > 200:
            pixmap = pixmap.scaled(350, 200, Qt.KeepAspectRatio, Qt.SmoothTransformation)
